...
<ul id="slide-out" class="side-nav fixed">
    ...
    <li><a href="#!"><i class="material-icons">face</i>Imatges</a></li>
    <li><a href="#!"><i class="material-icons">face</i>Configuració</a></li>
    <li><a href="#!"><i class="material-icons">face</i>Incidencies</a></li>
    <div class="divider-mini"></div>
</ul>
